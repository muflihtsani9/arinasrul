...
(function (window, document) {
  ...
  function initMusic() {
    ...
    // Prevent double playback from hot reloads or SPA navigations
    if (window.__oceanAudioInstance) {
      window.__oceanAudioInstance.pause();
      window.__oceanAudioInstance.src = '';
    }
    
    const audio     = new Audio();
    window.__oceanAudioInstance = audio;
